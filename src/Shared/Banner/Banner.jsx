  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-white flex flex-col items-center justify-center px-6 py-16 relative">
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between gap-12">
        ...
        {/* ===== Left Side ===== */}
        <div className="flex flex-col items-center md:items-end text-center md:text-right space-y-8 max-w-xl w-full">
          {/* Heading */}
          <div>
          ...
          {/* Feature List */}
          <div className="w-full bg-white p-4 rounded-xl shadow border max-w-md mx-auto md:mx-0">
            <h3 className="text-lg font-bold text-gray-800 mb-2">Why Choose Us?</h3>
            <div className="space-y-3">
              {["Get certificate", "Get membership"].map((item, i) => (
                <div
                  key={i}
                  className="flex justify-center md:justify-end items-center gap-3 text-gray-700 hover:text-indigo-600 transition"
                >
                  <span>{item}</span>
          ...
          {/* Buttons */}
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-end gap-4 mt-4 flex-wrap max-w-md mx-auto md:mx-0">
        ...
        <div className="relative mt-10 md:mt-0 flex justify-center md:justify-start w-full max-w-xl">
          {/* Image */}
          <div className="relative z-0">
            <img
              src={banner1}
              alt="Banner"
              className="w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-3xl shadow-xl object-cover border-8 border-white"
            />
          </div>

          {/* Stats Card - Bottom Left */}
          <div className="absolute -bottom-5 -left-5 bg-white p-4 rounded-2xl shadow-lg border border-gray-100 w-56 z-10">
